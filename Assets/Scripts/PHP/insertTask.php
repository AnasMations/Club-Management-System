...
RIGHT JOIN Student s ON a.StudentID = s.StudentID
...
$sql3 = "INSERT INTO Assigned (TaskDate, TaskStatus, TaskID, StudentID) 
VALUES ('$TaskDate', 'Not Started', $TaskID, $StudentID)";
